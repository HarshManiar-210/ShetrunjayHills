...
const GROUP_STYLE: Record<string, { accent: SectionAccent; icon: LucideIcon }> = {
  ...
  "flood-0-5m": { accent: "water", icon: Waves },
  "flood-1m": { accent: "water", icon: Waves },
  "flood-2m": { accent: "water", icon: Waves },
  "flood-5m": { accent: "water", icon: Waves },
  "flood-10m": { accent: "water", icon: Waves },
